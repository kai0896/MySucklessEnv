...
static char *fonts[]          = { "JetBrainsMono:size=12", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
static char normbgcolor[]           = "#111111";
static char normbordercolor[]       = "#1F1E1E";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#689097";
